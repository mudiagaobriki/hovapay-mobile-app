...
export default function ElectricityScreen() {
    ...
    const processPayment = async (transactionData: any) => {
        try {
            console.log('Sending electricity payment request:', transactionData);
            ...
            if (isActuallySuccessful) {
                ...
                Alert.alert(
                    'Payment Successful!',
                    `₦${transactionData.amount} has been credited to meter ${transactionData.billersCode} for ${transactionData.customerName}`,
                    [
                        {
                            text: 'View Receipt',
                            onPress: () => {
                                router.push({
                                    ...
                                    params: {
                                        ...
                                        status: 'successful',
                                        serviceName: `${transactionData.providerName} - ${transactionData.variation_code}`,
                                        phone: transactionData.phone
                                    }
                                });
                            }
                ...
                <View style={styles.modalContent}>
                    ...
                    <View style={styles.transactionSummary}>
                        <Text style={styles.summaryText}>
                            {selectedProvider?.name.replace(' Electric', '')} Bill
                        </Text>
                        <Text style={styles.summaryAmount}>
                            {pendingTransaction ? formatCurrency(pendingTransaction.amount) : ''}
                        </Text>
                        <Text style={styles.summaryPhone}>
                            {pendingTransaction ? `Meter: ${pendingTransaction.billersCode}` : ''}
                        </Text>
